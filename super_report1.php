...
<body>
	...
	<aside id="sidebar" class="sidebar">
		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link " href="super_report1.php">
					<i class="bi bi-arrow-right-square-fill"></i>
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">LEVEL 1 APPROVED LIST - REPORT</li>
				</ol>
			</nav>
		</div><!-- End Page Title -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <h5 class="card-title">REPORTS > LEVEL 1 APPROVED LIST - REPORT</h5>
							...
							<thead class="thead-dark">
								...
								<tbody>
                                    ...
                                    $sql = "SELECT lr.id, lr.proof_added, lr.customer_id, lr.loan_amount, lr.loan_tenure, lr.purpose,
                                            ...
                                            WHERE lr.status = 'Level One Approved'";
...
<script>
			...
			tempLink.download = "<?php echo isset($_GET['from_date']) ? $_GET['from_date'] : ''; ?> - <?php echo isset($_GET['to_date']) ? $_GET['to_date'] : ''; ?> - LEVEL 1 APPROVED.csv"; // Set file name
			tempLink.click();
		}
		</script>
</html>              